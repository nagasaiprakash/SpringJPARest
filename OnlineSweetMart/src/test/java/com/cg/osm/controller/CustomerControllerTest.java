...
@WebMvcTest(controllers = CustomerController.class)
 class CustomerControllerTest {
	...
	void test_findCustomerById() throws Exception {
		BDDMockito.given(customerservice.findCustomerById(123)).willReturn(Optional.of(new Customer(123, "Prakash",
				"nagasaiprakash@gmail.com", new Address("Hyderabad", "9441996930", "500081"), null)));
	...
	void test_addCustomer() throws Exception {
		Customer cust1 = new Customer(123, "Prakash", "nagasaiprakash@gmail.com",
				new Address("Hyderabad", "9441996930", "500081"), null);
	...
	void test_findCustomerByName() throws Exception {
		BDDMockito.given(customerservice.findCustomerByName("Prakash")).willReturn(Optional.of(new Customer(123,
				"Prakash", "nagasaiprakash@gmail.com", new Address("Hyderabad", "9441996930", "500081"), null)));
		mockmvc.perform(MockMvcRequestBuilders.get("/customer/name/Prakash")).andExpect(status().isOk());
	}
	...
	void test_findCustomerByName_ThrowCustomerNotFoundException() throws Exception {
		BDDMockito.given(customerservice.findCustomerByName(Mockito.anyString()))
				.willThrow(new CustomerNotFoundException("Customer not found"));
		mockmvc.perform(MockMvcRequestBuilders.get("/customer/name/Prakash")).andExpect(status().isNotFound());
	}

	@Test
	void test_showAllCustomers() throws Exception {
		Customer cust1 = new Customer(123, "Prakash", "nagasaiprakash@gmail.com",
				new Address("Hyderabad", "8456516665", "500081"), null);
